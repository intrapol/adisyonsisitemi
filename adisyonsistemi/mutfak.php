            ...
            for ($kolon = 0; $kolon < $satir_basina_masa; $kolon++) {
                ...
                if ($masa_id && isset($masa_siparisleri[$masa_id])) {
                    ...
                    foreach ($siparisler as $siparis) {
                        ...
                        echo '<div class="border-bottom mb-2 pb-2" style="border-color: #dee2e6 !important;">';
                        
                        // Ürün adı ve adet
                        echo '<div class="d-flex justify-content-between align-items-center mb-1">';
                        echo '<span class="fw-bold text-uppercase" style="font-size: 0.8rem; color: #495057;">' . $urun_adi . '</span>';
                        ...
                        for ($satir = 0; $satir < $satir_sayisi; $satir++) {
                            ...
                            for ($kolon = 0; $kolon < $urun_basina_kolon; $kolon++) {
                                ...
                                if ($urun_adi) {
                                    ...
                                    echo '<div class="d-flex justify-content-between align-items-center p-3 bg-light rounded border">';
                                    echo '<span class="fw-bold text-uppercase" style="font-size: 0.9rem; color: #495057;">' . $urun_adi . '</span>'; 
                                    echo '<span class="badge bg-warning text-dark" style="font-size: 1rem; padding: 0.5rem 0.75rem;">' . $adet . '</span>';
                                    echo '</div>';
                                    echo '</div>';
                                }
                            }
