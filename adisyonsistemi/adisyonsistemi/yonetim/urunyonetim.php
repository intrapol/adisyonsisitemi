...
// Kategorileri çek
$kategoriler = [];
$kategori_sorgu = $conn->query("SELECT id, kategori_adi FROM kategori ORDER BY kategori_adi ASC");
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-0">
                    <table class="table table-hover mb-0">
                        ...
                        $sql_katsiz = "SELECT u.id, u.urun_adi, u.urun_fiyat, u.kategori_id, k.kategori_adi 
                                       FROM urunler u 
                                       LEFT JOIN kategori k ON u.kategori_id = k.id 
                                       WHERE u.kategori_id IS NULL OR u.kategori_id NOT IN (SELECT id FROM kategori)
                                       ORDER BY u.id ASC";
                        $result_katsiz = $conn->query($sql_katsiz);
